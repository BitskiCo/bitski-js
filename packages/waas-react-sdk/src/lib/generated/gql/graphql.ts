...
export type BatchTokenMintV2 = ActivityV2 &
  BatchTokenTransferV2 & {
...
export type BatchTokenReceivedV2 = ActivityV2 &
  BatchTokenTransferV2 & {
...
export type BatchTokenSentV2 = ActivityV2 &
  BatchTokenTransferV2 & {
...
export type BatchTokenTransferAbsoluteV2 = ActivityV2 &
  BatchTokenTransferV2 & {
...
export type TokenAirdropV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TokenApprovalAll = Activity &
  TokenApproval & {
...
export type TokenApprovalAllV2 = ActivityV2 &
  TokenApprovalV2 & {
...
export type TokenApproved = Activity &
  TokenApproval & {
...
export type TokenApprovedV2 = ActivityV2 &
  TokenApprovalV2 & {
...
export type TokenBurn = Activity &
  TokenTransfer & {
...
export type TokenBurnV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TokenMint = Activity &
  TokenTransfer & {
...
export type TokenMintV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TokenPurchased = Activity &
  TokenSale & {
...
export type TokenPurchasedV2 = ActivityV2 &
  TokenSaleV2 & {
...
export type TokenReceived = Activity &
  TokenTransfer & {
...
export type TokenReceivedV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TokenRejectAll = Activity &
  TokenApproval & {
...
export type TokenRejectAllV2 = ActivityV2 &
  TokenApprovalV2 & {
...
export type TokenRevokeApprovalV2 = ActivityV2 &
  TokenApprovalV2 & {
...
export type TokenSaleAbsoluteV2 = ActivityV2 &
  TokenSaleV2 & {
...
export type TokenSent = Activity &
  TokenTransfer & {
...
export type TokenSentV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TokenSold = Activity &
  TokenSale & {
...
export type TokenSoldV2 = ActivityV2 &
  TokenSaleV2 & {
...
export type TokenTransferAbsoluteV2 = ActivityV2 &
  TokenTransferV2 & {
...
export type TotalBalanceUsdQuery = {
  __typename?: 'Query';
  currencyBalances: {
    __typename?: 'CurrencyBalancesResult';
    totalBalanceUSD: { __typename?: 'Amount'; formatted?: string | null };
    connections: {
      __typename?: 'CurrencyBalanceConnection';
      nodes: Array<{
        __typename?: 'CurrencyBalance';
        address: { __typename?: 'EVMAddress'; raw: string; truncated?: string | null };
        amountV2: {
          __typename?: 'CurrencyAmount';
        ...
        currency: {
          ...
          symbol?: string | null;
          decimals?: number | null;
          image?: { __typename?: 'RemoteAsset'; url: string } | null;
        };
      }>;
    };
  };
...
export const TotalBalanceUsdDocument = {
  kind: 'Document',
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GetCurrencyBalancesV2Input' },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'currencyBalances' },
            arguments: [
              {
                kind: 'Argument',
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: 'formatted' } }],
                  },
                },
                {
                  kind: 'Field',
...
} as unknown as DocumentNode<TotalBalanceUsdQuery, TotalBalanceUsdQueryVariables>;
