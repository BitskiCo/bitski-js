...
export const SUPPORTED_CHAIN_IDS = [
  ...
  5700, 5777, 5851, 5869, 6626, 7341, 7878, 8000, 8001, 8029, 8080, 8217, 8285, 8453, 8723, 8724,
  8888, 8995, 9000, 9001, 9100, 9527, 9999, 10000, 10001, 10101, 10823, 11111, 11437, 12051, 12052,
  13381, 16000, 16001, 19845, 21337, 21816, 24484, 24734, 31102, 31337, 32659, 39797, 42069, 42161,
  42220, 42261, 42262, 43110, 43113, 43114, 44787, 45000, 47805, 49797, 53935, 55555, 55556, 60000,
  60001, 60002, 60103, 62320, 63000, 63001, 69420, 70000, 70001, 70002, 70103, 71393, 73799, 78110,
  80001, 84531, 99998, 99999, 100000, 100001, 100002, 100003, 100004, 100005, 100006, 100007,
  100008, 108801, 110000, 110001, 110002, 110003, 110004, 110005, 110006, 110007, 110008, 200101,
  200625, 201018, 201030, 210425, 234666, 246529, 246785, 281121, 333888, 333999, 421611, 444900,
  666666, 888888, 955305, 1313114, 1313500, 1337702, 2203181, 7762959, 11155111, 13371337, 18289463,
  20181205, 28945486, 35855456, 61717561, 99415706, 192837465, 245022926, 245022934, 245022940,
  311752642, 356256156, 486217935, 1122334455, 1313161554, 1313161555, 1313161556, 1666600000,
  1666600001, 1666600002, 1666600003, 1666700000, 1666700001, 1666700002, 1666700003, 2021121117,
  3125659152, 4216137055, 11297108099, 11297108109, 197710212030, 197710212031, 6022140761023,
  868455272153094,
].map(toHex);
...
export const Base = makeChainDef(8453, 'Base', 'https://basescan.org/');
export const Goerli = makeChainDef(5, 'Görli', 'https://goerli.etherscan.io/');
export const BaseGoerli = makeChainDef(84531, 'BaseGörli', 'https://goerli.basescan.org/');
...
export const ZkSyncEraTestnet = makeChainDef(
  280,
  'zkSync Era Testnet',
