(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("Oidc"));
	else if(typeof define === 'function' && define.amd)
		define("bitski", ["Oidc"], factory);
	else if(typeof exports === 'object')
		exports["bitski"] = factory(require("Oidc"));
	else
		root["bitski"] = factory(root["Oidc"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__oauthhttpprovider__ = __webpack_require__(1);
...
function InitializeWeb3(settings) {
    if (typeof web3 !== 'undefined') {
        ...
        var web3Client = new Web3(new __WEBPACK_IMPORTED_MODULE_0__oauthhttpprovider__["a" /* default */]("https://keep-api.outtherelabs.com/v1/web3/kovan", 0, settings));
        return web3Client;
    }
};
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_xhr2__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_xhr2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_xhr2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_oidc_client__ = __webpack_require__(8);
...
__WEBPACK_IMPORTED_MODULE_1_oidc_client___default.a.Log.logger = console;
__WEBPACK_IMPORTED_MODULE_1_oidc_client___default.a.Log.level = __WEBPACK_IMPORTED_MODULE_1_oidc_client___default.a.Log.DEBUG;
...
var OAuthHttpProvider = function (host, timeout, settings) {
  ...
  var userManager = new __WEBPACK_IMPORTED_MODULE_1_oidc_client___default.a.UserManager(settings);
  ...
  userManager.getUser().then(function (user) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_oidc_client___default.a.UserManager().signinRedirectCallback();
  }).catch(function (err) {
...
OAuthHttpProvider.prototype.prepareRequest = function (async) {
  ...
  if (async) {
    request = new __WEBPACK_IMPORTED_MODULE_0_xhr2___default.a();
...
/* harmony default export */ __webpack_exports__["a"] = (OAuthHttpProvider);
