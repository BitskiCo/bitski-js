...
export class BitskiProvider extends OAuthHttpProvider {
    ...
    constructor(client_id: string, redirect_uri?: string, post_logout_redirect_uri?: string) {
        super('https://api-standard.apps.bitski-prod-us-west-2.outtherelabs.com/v1/web3/kovan', 0, new BitskiProviderSettings('https://hydra-hardened.outtherelabs.com/', client_id, redirect_uri, post_logout_redirect_uri));
    }
